...
class ProducesControllerTest < ActionController::TestCase
  ...
  test "should create produce" do
    assert_difference('Produce.count') do
      post :create, produce: { description: @produce.description, image_url: @produce.image_url, price: @produce.price, title: @produce.title }
    end
  ...
  test "should update produce" do
    patch :update, id: @produce, produce: { description: @produce.description, image_url: @produce.image_url, price: @produce.price, title: @produce.title }
    assert_redirected_to produce_path(assigns(:produce))
  end
